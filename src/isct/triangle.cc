...
static int randomseed_counter{0};
...

{
  ...
  if (printtri.tri == m->dummytri) {
    ...
    printf("    [0] = x%lx  %d\n", (__int64)printtri.tri, (int)printtri.orient);
  }
...

{
  ...
  if (printsh.ss == m->dummysub) {
    ...
    printf("    [0] = x%lx  %d\n", (__int64)printsh.ss, (int)printsh.ssorient);
  }
 ...
 */
/*  present, and so forth.  Other entities are frequently bonded to */ /*  `dummytri'
                                                                          and
                                                                          `dummysub'
                                                                          as if
                                                                          they
...

{
  ...
  // std::cout<<randomseed_counter++<<", "<<randomseed<<", " << choices <<
  // std::endl;
...
#ifdef ANSI_DECLARATORS
struct splaynode *
circletopinsert(struct mesh *m, struct behavior *b, struct splaynode *splayroot,
                struct otri *newkey, vertex pa, vertex pb, vertex pc, REal topy)
#else  /* not ANSI_DECLARATORS */
...
void readholes(struct mesh *m, struct behavior *b, FILE *polyfile,
               char *polyfilename, REal **hlist, __int64 *holes, REal **rlist,
               __int64 *regions)
#else  /* not ANSI_DECLARATORS */
