...
public:
  ...
  using TetSizeFunc =
      std::function<bool((REAL *, REAL *, REAL *, REAL *, REAL *, REAL))>;
...
#define fastlookup(pool, index)                                                \
  ...
  //   segments.
  memorypool *tetrahedrons{NULL}, *subfaces{NULL}, *subsegs{NULL},
      *points{NULL};
  ...
  REAL xmax{0}, xmin{0}, ymax{0}, ymin{0}, zmax{0},
      zmin{0}; // Bounding box of points.
  ...
  long st_segref_count{0}, st_facref_count{0},
      st_volref_count{0}; // Steiner points.
