...
ResultState checkState(const CorkTriMesh &cmesh) {
...
void computeUnion(const CorkTriMesh &in0, const CorkTriMesh &in1,
                  CorkTriMesh &out) {
...
void computeDifference(const CorkTriMesh &in0, const CorkTriMesh &in1,
                       CorkTriMesh &out) {
  CorkMesh cmIn0, cmIn1;
  corkTriMesh2CorkMesh(in0, cmIn0);
  corkTriMesh2CorkMesh(in1, cmIn1);
...
void computeIntersection(const CorkTriMesh &in0, const CorkTriMesh &in1,
                         CorkTriMesh &out) {
...
void computeSymmetricDifference(const CorkTriMesh &in0, const CorkTriMesh &in1,
                                CorkTriMesh &out) {
...
void resolveIntersections(const CorkTriMesh &in0, const CorkTriMesh &in1,
                          CorkTriMesh &out) {
